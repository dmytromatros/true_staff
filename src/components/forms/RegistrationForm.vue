  ...
  <div class="registration-form">
    <div class="registration-form__wrapper">
      ...
      <div v-if="role == 'user'" class="registration-form__user">
        <TextInput placeholder="Ім'я" type="text" v-model="userInfo.name" />
        <TextInput
          placeholder="Прізвище"
          type="text"
          v-model="userInfo.surname"
        />
        <TextInput placeholder="E-mail" type="email" v-model="userInfo.email" />
        <TextInput
          placeholder="Пароль"
          type="password"
      ...
      <div v-if="role == 'company'" class="registration-form__company">
        ...
        />
        <TextInput
          placeholder="Логін (це має бути код компанії)"
          type="text"
...
export default {
  ...
  components: { TextInput, CheckboxInput, RadioCheckboxInput, SelectInput },
  methods: {
    selectRole(role) {
      this.role = role;
    },
