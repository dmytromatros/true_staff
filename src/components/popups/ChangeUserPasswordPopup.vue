<template>
  <DefaultPopup :isShown="isShown" @close="close" title="Змінити пароль" @confirm="changePass" :loadingButton="loadingButton" :loading="loading">
...
export default {
  ...
  methods: {
    ...
    changePass() {
      ...
      this.$store
        .dispatch('editUserPasswordAction', {
